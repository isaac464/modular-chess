...
Us and our plans for this project:

This project is currently run by me(isaac464) and my mate(Aaron4568), this is a small project that we are working on in our free time so it will be fairly unregular in both time and size, our plans for this project as of now is to ultimatly make a website, and possibly an app.
